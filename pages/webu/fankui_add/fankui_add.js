...
Component({
    ...
    lifetimes: {
        attached() {
            ...
            let form = {
                userid : userInfo && userInfo.role == 'user' ? userInfo.id:'',
                inid : userInfo && userInfo.role == 'institution' ? userInfo.id:'',
            }
            this.setData({
                userInfo:userInfo,
                form:form
    ...
    methods: {
        ...
        async onConfirm() {
            ...
            //保存
            let resp =await Http.post(`/webu/fankui/save`,this.data.form)
            if(resp.success){
